...
\subsubsection[{\texorpdfstring{arrange\+Content(\$content)}{arrangeContent($content)}}]{\setlength{\rightskip}{0pt plus 5cm}member\+A\+P\+I\+::arrange\+Content (
...
\subsubsection[{\texorpdfstring{arrange\+Content\+List(\$content\+\_\+list)}{arrangeContentList($content_list)}}]{\setlength{\rightskip}{0pt plus 5cm}member\+A\+P\+I\+::arrange\+Content\+List (
\begin{DoxyParamCaption}
\item[{}]{\$content\+\_\+list}
\end{DoxyParamCaption}
...
\subsubsection[{\texorpdfstring{disp\+Saved\+Document\+List(\&\$o\+Module)}{dispSavedDocumentList(&$oModule)}}]{\setlength{\rightskip}{0pt plus 5cm}member\+A\+P\+I\+::disp\+Saved\+Document\+List (
\begin{DoxyParamCaption}
\item[{\&}]{\$o\+Module}
\end{DoxyParamCaption}
