...
\subsubsection[{\texorpdfstring{init()}{init()}}]{\setlength{\rightskip}{0pt plus 5cm}comment\+View\+::init (
...
\subsubsection[{\texorpdfstring{trigger\+Disp\+Comment\+Addition\+Setup(\&\$obj)}{triggerDispCommentAdditionSetup(&$obj)}}]{\setlength{\rightskip}{0pt plus 5cm}comment\+View\+::trigger\+Disp\+Comment\+Addition\+Setup (
\begin{DoxyParamCaption}
\item[{\&}]{\$obj}
\end{DoxyParamCaption}
