...
\subsubsection[{\texorpdfstring{\+\_\+clear\+Error\+Session()}{_clearErrorSession()}}]{\setlength{\rightskip}{0pt plus 5cm}Module\+Handler\+::\+\_\+clear\+Error\+Session (
...
\subsubsection[{\texorpdfstring{\+\_\+get\+Module\+File\+Path(\$module, \$type, \$kind, \&\$class\+Path, \&\$high\+Class\+File, \&\$class\+File, \&\$instance\+Name)}{_getModuleFilePath($module, $type, $kind, &$classPath, &$highClassFile, &$classFile, &$instanceName)}}]{\setlength{\rightskip}{0pt plus 5cm}Module\+Handler\+::\+\_\+get\+Module\+File\+Path (
\begin{DoxyParamCaption}
\item[{}]{\$module, }
\item[{}]{\$type, }
\item[{}]{\$kind, }
...
\subsubsection[{\texorpdfstring{\+\_\+set\+Http\+Status\+Message(\$code)}{_setHttpStatusMessage($code)}}]{\setlength{\rightskip}{0pt plus 5cm}Module\+Handler\+::\+\_\+set\+Http\+Status\+Message (
\begin{DoxyParamCaption}
\item[{}]{\$code}
\end{DoxyParamCaption}
...
\subsubsection[{\texorpdfstring{\+\_\+set\+Input\+Error\+To\+Context()}{_setInputErrorToContext()}}]{\setlength{\rightskip}{0pt plus 5cm}Module\+Handler\+::\+\_\+set\+Input\+Error\+To\+Context (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
...
\subsubsection[{\texorpdfstring{\+\_\+set\+Input\+Value\+To\+Session()}{_setInputValueToSession()}}]{\setlength{\rightskip}{0pt plus 5cm}Module\+Handler\+::\+\_\+set\+Input\+Value\+To\+Session (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
...
\subsubsection[{\texorpdfstring{display\+Content(\$o\+Module=\+N\+U\+L\+L)}{displayContent($oModule=NULL)}}]{\setlength{\rightskip}{0pt plus 5cm}Module\+Handler\+::display\+Content (
\begin{DoxyParamCaption}
...
\subsubsection[{\texorpdfstring{get\+Error\+Type(\$errno)}{getErrorType($errno)}}]{\setlength{\rightskip}{0pt plus 5cm}static Module\+Handler\+::get\+Error\+Type (
\begin{DoxyParamCaption}
\item[{}]{\$errno}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [static]}}\hypertarget{classModuleHandler_a140184b247fc515e6f49eb87ff59ae74}{}\label{classModuleHandler_a140184b247fc515e6f49eb87ff59ae74}
...
\subsubsection[{\texorpdfstring{get\+Module\+Instance(\$module, \$type= \textquotesingle{}view\textquotesingle{}, \$kind= \textquotesingle{}\textquotesingle{})}{getModuleInstance($module, $type= 'view', $kind= '')}}]{\setlength{\rightskip}{0pt plus 5cm}\& Module\+Handler\+::get\+Module\+Instance (
\begin{DoxyParamCaption}
\item[{}]{\$module, }
\item[{}]{\$type = {\ttfamily \textquotesingle{}view\textquotesingle{}}, }
\item[{}]{\$kind = {\ttfamily \textquotesingle{}\textquotesingle{}}}
\end{DoxyParamCaption}
)}\hypertarget{classModuleHandler_aea2e4d82f816ee25ec97ce2c830e6860}{}\label{classModuleHandler_aea2e4d82f816ee25ec97ce2c830e6860}
...
\subsubsection[{\texorpdfstring{get\+Module\+Path(\$module)}{getModulePath($module)}}]{\setlength{\rightskip}{0pt plus 5cm}Module\+Handler\+::get\+Module\+Path (
\begin{DoxyParamCaption}
\item[{}]{\$module}
\end{DoxyParamCaption}
...
\subsubsection[{\texorpdfstring{init()}{init()}}]{\setlength{\rightskip}{0pt plus 5cm}Module\+Handler\+::init (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
...
\index{Module\+Handler@{Module\+Handler}!Module\+Handler@{Module\+Handler}}
\subsubsection[{\texorpdfstring{Module\+Handler(\$module= \textquotesingle{}\textquotesingle{}, \$act= \textquotesingle{}\textquotesingle{}, \$mid= \textquotesingle{}\textquotesingle{}, \$document\+\_\+srl= \textquotesingle{}\textquotesingle{}, \$module\+\_\+srl= \textquotesingle{}\textquotesingle{})}{ModuleHandler($module= '', $act= '', $mid= '', $document_srl= '', $module_srl= '')}}]{\setlength{\rightskip}{0pt plus 5cm}Module\+Handler\+::\+Module\+Handler (
\begin{DoxyParamCaption}
...
\end{DoxyParamCaption}
)}\hypertarget{classModuleHandler_abfb13533d16d60323823189ccca73237}{}\label{classModuleHandler_abfb13533d16d60323823189ccca73237}
...
\subsubsection[{\texorpdfstring{proc\+Module()}{procModule()}}]{\setlength{\rightskip}{0pt plus 5cm}Module\+Handler\+::proc\+Module (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
...
\subsubsection[{\texorpdfstring{shutdown\+Handler()}{shutdownHandler()}}]{\setlength{\rightskip}{0pt plus 5cm}Module\+Handler\+::shutdown\+Handler (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
...
\subsubsection[{\texorpdfstring{trigger\+Call(\$trigger\+\_\+name, \$called\+\_\+position, \&\$obj)}{triggerCall($trigger_name, $called_position, &$obj)}}]{\setlength{\rightskip}{0pt plus 5cm}Module\+Handler\+::trigger\+Call (
\begin{DoxyParamCaption}
\item[{}]{\$trigger\+\_\+name, }
...
Definition at line 1267 of file Module\+Handler.\+class.\+php.
...
\subsubsection[{\texorpdfstring{xe\+Error\+Log(\$errnumber, \$errormassage, \$errorfile, \$errorline, \$errorcontext)}{xeErrorLog($errnumber, $errormassage, $errorfile, $errorline, $errorcontext)}}]{\setlength{\rightskip}{0pt plus 5cm}static Module\+Handler\+::xe\+Error\+Log (
\begin{DoxyParamCaption}
\item[{}]{\$errnumber, }
\item[{}]{\$errormassage, }
\item[{}]{\$errorfile, }
...
\item[{}]{\$errorcontext}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [static]}}\hypertarget{classModuleHandler_ae8a81ab7540edc526035f1375706dd7a}{}\label{classModuleHandler_ae8a81ab7540edc526035f1375706dd7a}
...
\subsubsection[{\texorpdfstring{\$act}{$act}}]{\setlength{\rightskip}{0pt plus 5cm}Module\+Handler\+::\$act = N\+U\+LL}\hypertarget{classModuleHandler_ae332c92a6ad1e9e823281d708088a0ff}{}\label{classModuleHandler_ae332c92a6ad1e9e823281d708088a0ff}
