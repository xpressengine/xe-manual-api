...
\subsubsection[{\texorpdfstring{get\+Life\+Time()}{getLifeTime()}}]{\setlength{\rightskip}{0pt plus 5cm}session\+Model\+::get\+Life\+Time (
...
\subsubsection[{\texorpdfstring{get\+Logged\+Members(\$args)}{getLoggedMembers($args)}}]{\setlength{\rightskip}{0pt plus 5cm}session\+Model\+::get\+Logged\+Members (
\begin{DoxyParamCaption}
\item[{}]{\$args}
\end{DoxyParamCaption}
...
\subsubsection[{\texorpdfstring{init()}{init()}}]{\setlength{\rightskip}{0pt plus 5cm}session\+Model\+::init (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
...
\subsubsection[{\texorpdfstring{read(\$session\+\_\+key)}{read($session_key)}}]{\setlength{\rightskip}{0pt plus 5cm}session\+Model\+::read (
\begin{DoxyParamCaption}
\item[{}]{\$session\+\_\+key}
\end{DoxyParamCaption}
