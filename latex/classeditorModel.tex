...
\index{editor\+Model@{editor\+Model}!get\+Cache\+File@{get\+Cache\+File}}
\index{get\+Cache\+File@{get\+Cache\+File}!editor\+Model@{editor\+Model}}
\subsubsection[{\texorpdfstring{get\+Cache\+File(\$filter\+\_\+enabled=true, \$site\+\_\+srl=0)}{getCacheFile($filter_enabled=true, $site_srl=0)}}]{\setlength{\rightskip}{0pt plus 5cm}editor\+Model\+::get\+Cache\+File (
...
\index{editor\+Model@{editor\+Model}!get\+Component@{get\+Component}}
\index{get\+Component@{get\+Component}!editor\+Model@{editor\+Model}}
\subsubsection[{\texorpdfstring{get\+Component(\$component\+\_\+name, \$site\+\_\+srl=0)}{getComponent($component_name, $site_srl=0)}}]{\setlength{\rightskip}{0pt plus 5cm}editor\+Model\+::get\+Component (
\begin{DoxyParamCaption}
...
\index{editor\+Model@{editor\+Model}!get\+Component\+List@{get\+Component\+List}}
\index{get\+Component\+List@{get\+Component\+List}!editor\+Model@{editor\+Model}}
\subsubsection[{\texorpdfstring{get\+Component\+List(\$filter\+\_\+enabled=true, \$site\+\_\+srl=0, \$from\+\_\+db=false)}{getComponentList($filter_enabled=true, $site_srl=0, $from_db=false)}}]{\setlength{\rightskip}{0pt plus 5cm}editor\+Model\+::get\+Component\+List (
\begin{DoxyParamCaption}
\item[{}]{\$filter\+\_\+enabled = {\ttfamily true}, }
\item[{}]{\$site\+\_\+srl = {\ttfamily 0}, }
...
\index{editor\+Model@{editor\+Model}!get\+Component\+Object@{get\+Component\+Object}}
\index{get\+Component\+Object@{get\+Component\+Object}!editor\+Model@{editor\+Model}}
\subsubsection[{\texorpdfstring{get\+Component\+Object(\$component, \$editor\+\_\+sequence=0, \$site\+\_\+srl=0)}{getComponentObject($component, $editor_sequence=0, $site_srl=0)}}]{\setlength{\rightskip}{0pt plus 5cm}editor\+Model\+::get\+Component\+Object (
\begin{DoxyParamCaption}
\item[{}]{\$component, }
...
\index{editor\+Model@{editor\+Model}!get\+Component\+Xml\+Info@{get\+Component\+Xml\+Info}}
\index{get\+Component\+Xml\+Info@{get\+Component\+Xml\+Info}!editor\+Model@{editor\+Model}}
\subsubsection[{\texorpdfstring{get\+Component\+Xml\+Info(\$component)}{getComponentXmlInfo($component)}}]{\setlength{\rightskip}{0pt plus 5cm}editor\+Model\+::get\+Component\+Xml\+Info (
\begin{DoxyParamCaption}
\item[{}]{\$component}
\end{DoxyParamCaption}
...
\index{editor\+Model@{editor\+Model}!get\+Dr\+Component\+Xml\+Info@{get\+Dr\+Component\+Xml\+Info}}
\index{get\+Dr\+Component\+Xml\+Info@{get\+Dr\+Component\+Xml\+Info}!editor\+Model@{editor\+Model}}
\subsubsection[{\texorpdfstring{get\+Dr\+Component\+Xml\+Info(\$dr\+Component\+Name)}{getDrComponentXmlInfo($drComponentName)}}]{\setlength{\rightskip}{0pt plus 5cm}editor\+Model\+::get\+Dr\+Component\+Xml\+Info (
\begin{DoxyParamCaption}
...
\index{editor\+Model@{editor\+Model}!get\+Editor@{get\+Editor}}
\index{get\+Editor@{get\+Editor}!editor\+Model@{editor\+Model}}
\subsubsection[{\texorpdfstring{get\+Editor(\$upload\+\_\+target\+\_\+srl=0, \$option=null)}{getEditor($upload_target_srl=0, $option=null)}}]{\setlength{\rightskip}{0pt plus 5cm}editor\+Model\+::get\+Editor (
\begin{DoxyParamCaption}
\item[{}]{\$upload\+\_\+target\+\_\+srl = {\ttfamily 0}, }
\item[{}]{\$option = {\ttfamily {\bf null}}}
\end{DoxyParamCaption}
...
\index{editor\+Model@{editor\+Model}!get\+Editor\+Config@{get\+Editor\+Config}}
\index{get\+Editor\+Config@{get\+Editor\+Config}!editor\+Model@{editor\+Model}}
\subsubsection[{\texorpdfstring{get\+Editor\+Config(\$module\+\_\+srl=null)}{getEditorConfig($module_srl=null)}}]{\setlength{\rightskip}{0pt plus 5cm}editor\+Model\+::get\+Editor\+Config (
\begin{DoxyParamCaption}
...
\index{editor\+Model@{editor\+Model}!get\+Editor\+Skin\+List@{get\+Editor\+Skin\+List}}
\index{get\+Editor\+Skin\+List@{get\+Editor\+Skin\+List}!editor\+Model@{editor\+Model}}
\subsubsection[{\texorpdfstring{get\+Editor\+Skin\+List()}{getEditorSkinList()}}]{\setlength{\rightskip}{0pt plus 5cm}editor\+Model\+::get\+Editor\+Skin\+List (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
...
\index{editor\+Model@{editor\+Model}!get\+Module\+Editor@{get\+Module\+Editor}}
\index{get\+Module\+Editor@{get\+Module\+Editor}!editor\+Model@{editor\+Model}}
\subsubsection[{\texorpdfstring{get\+Module\+Editor(\$type= \textquotesingle{}document\textquotesingle{}, \$module\+\_\+srl, \$upload\+\_\+target\+\_\+srl, \$primary\+\_\+key\+\_\+name, \$content\+\_\+key\+\_\+name)}{getModuleEditor($type= 'document', $module_srl, $upload_target_srl, $primary_key_name, $content_key_name)}}]{\setlength{\rightskip}{0pt plus 5cm}editor\+Model\+::get\+Module\+Editor (
\begin{DoxyParamCaption}
...
\end{DoxyParamCaption}
)}\hypertarget{classeditorModel_a7870d2a76cbc33a9dbaea3f865edd313}{}\label{classeditorModel_a7870d2a76cbc33a9dbaea3f865edd313}
...
\index{editor\+Model@{editor\+Model}!get\+Saved\+Doc@{get\+Saved\+Doc}}
\index{get\+Saved\+Doc@{get\+Saved\+Doc}!editor\+Model@{editor\+Model}}
\subsubsection[{\texorpdfstring{get\+Saved\+Doc(\$upload\+\_\+target\+\_\+srl)}{getSavedDoc($upload_target_srl)}}]{\setlength{\rightskip}{0pt plus 5cm}editor\+Model\+::get\+Saved\+Doc (
\begin{DoxyParamCaption}
\item[{}]{\$upload\+\_\+target\+\_\+srl}
\end{DoxyParamCaption}
...
\index{editor\+Model@{editor\+Model}!load\+Dr\+Components@{load\+Dr\+Components}}
\index{load\+Dr\+Components@{load\+Dr\+Components}!editor\+Model@{editor\+Model}}
\subsubsection[{\texorpdfstring{load\+Dr\+Components()}{loadDrComponents()}}]{\setlength{\rightskip}{0pt plus 5cm}editor\+Model\+::load\+Dr\+Components (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
...
\index{editor\+Model@{editor\+Model}!\$loaded\+\_\+component\+\_\+list@{\$loaded\+\_\+component\+\_\+list}}
