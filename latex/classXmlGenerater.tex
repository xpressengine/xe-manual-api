...
\subsubsection[{\texorpdfstring{generate(\&\$params)}{generate(&$params)}}]{\setlength{\rightskip}{0pt plus 5cm}Xml\+Generater\+::generate (
...
\subsubsection[{\texorpdfstring{get\+Xml\+Doc(\&\$params)}{getXmlDoc(&$params)}}]{\setlength{\rightskip}{0pt plus 5cm}Xml\+Generater\+::get\+Xml\+Doc (
\begin{DoxyParamCaption}
\item[{\&}]{\$params}
\end{DoxyParamCaption}
