...
\subsubsection[{\texorpdfstring{\+\_\+makexml(\$node)}{_makexml($node)}}]{\setlength{\rightskip}{0pt plus 5cm}Xml\+Generator\+::\+\_\+makexml (
...
\subsubsection[{\texorpdfstring{obj2xml(\$xml)}{obj2xml($xml)}}]{\setlength{\rightskip}{0pt plus 5cm}Xml\+Generator\+::obj2xml (
\begin{DoxyParamCaption}
\item[{}]{\$xml}
\end{DoxyParamCaption}
