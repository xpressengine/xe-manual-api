...
\subsubsection[{\texorpdfstring{get\+Instance()}{getInstance()}}]{\setlength{\rightskip}{0pt plus 5cm}Purifier\+::get\+Instance (
...
\index{Purifier@{Purifier}!Purifier@{Purifier}}
\subsubsection[{\texorpdfstring{Purifier()}{Purifier()}}]{\setlength{\rightskip}{0pt plus 5cm}Purifier\+::\+Purifier (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
...
\subsubsection[{\texorpdfstring{purify(\&\$content)}{purify(&$content)}}]{\setlength{\rightskip}{0pt plus 5cm}Purifier\+::purify (
\begin{DoxyParamCaption}
\item[{\&}]{\$content}
\end{DoxyParamCaption}
